...
class LineSearchMinimizer:
    ...
    def gradient_descent(self, f, x0, obj_tol, param_tol, max_iter):
        ...
        print(f'Iteration {"0":>5}/{max_iter} =\tlocation={x}\t\tf(x0)={val_curr}')
        ...
        for i in range(max_iter):
            ...
            print(f'Iteration {i+1:>5}/{max_iter} =\tlocation={x}\t\tf(x{i+1})={val_curr}')
    ...
    def newton(self, f, x0, obj_tol, param_tol, max_iter):
        ...
        print(f'Iteration {"0":>5}/{max_iter} =\tlocation ={x}\t\tf(x{0})={val_curr}')
